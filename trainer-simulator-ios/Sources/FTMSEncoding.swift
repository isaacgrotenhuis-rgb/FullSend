...
enum FTMSEncoding {
    ...
    static func encodeIndoorBikeData(speedKmh: Double, cadenceRpm: Double, resistanceLevel: Double, powerWatts: Double) -> Data {
        let instCadencePresent: UInt16 = 0x0004
        let resistancePresent: UInt16 = 0x0020
        let instPowerPresent: UInt16 = 0x0040
        let flags = instCadencePresent | resistancePresent | instPowerPresent
